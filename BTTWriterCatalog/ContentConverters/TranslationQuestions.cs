...
namespace BTTWriterCatalog.ContentConverters
{
    public static class TranslationQuestions
    {
        ...
        public static async Task<List<string>> ConvertAsync(IZipFileSystem fileSystem, string basePath, string outputPath, ResourceContainer resourceContainer, ILogger log)
        {
